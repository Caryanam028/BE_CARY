    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        return new CorsConfigurationSource() {
            ...
            public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                ...
                config.setAllowedOrigins(Arrays.asList("https://caryanamindia.com", "https://chic-vacherin-a1d7a6.netlify.app","http://localhost:5173", "http://localhost:63342","https://cffffftasting-production.up.railway.app","https://localhost","https://localhost:3000"));
